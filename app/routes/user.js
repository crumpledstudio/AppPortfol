...
router.get('/nif_validation', function(req, res, next) {
	res.render('user/nifvalidation', { layout: 'oferta_layout', tittle: 'NIF Validation Page' });
});

router.get('/business', function(req, res, next) {
	res.render('user/business_company_form', { layout: 'forms', tittle: 'Business Page' });
});

router.get('/businessnovo', function(req, res, next) {
	res.render('user/business_company_form_novo', { layout: 'forms', tittle: 'Business Page' });
});

router.get('/ideia', function(req, res, next) {
	res.render('user/business_ideia_form', { layout: 'forms', tittle: 'Ideia Page' });
});

router.get('/private', function(req, res, next) {
	res.render('user/investor_private_form', { layout: 'forms', tittle: 'Private Page' });
});

router.get('/colective', function(req, res, next) {
	res.render('user/investor_colective_form', { layout: 'forms', tittle: 'Colective Page' });
});
...
router.get('/upgrade', function(req, res, next) {
	...
	if (id_gerado != undefined) {
		request.get({
			...
			url: 'https://portapi-afonsoocosta53.c9users.io/user/memberinfo/',
...
router.get('/profile/:id', function(req, res, next) {
	...
	if (id_gerado != undefined) {
		request.get({
			...
			url: 'https://portapi-afonsoocosta53.c9users.io/user/profile/'
		}, function(error, response, body) {
			var body2 = JSON.parse(body);
...
router.get('/negociacoes', function(req, res, next) {
	var id_gerado = req.cookies['id_gerado'];
	if (id_gerado != undefined) {
		res.render('user/negociacoes', { layout: 'negociacoes', tittle: 'Negociacoes Page' });
	}
	else {
		res.redirect('../user/login');
	}
...
router.get('/comercial', function(req, res, next) {
	res.render('user/comercial_business', { layout: 'noGraphs', tittle: 'Negociacoes Page' });
});

router.get('/comercial_teste', function(req, res, next) {
	res.render('user/comercial_business_teste', { layout: 'noGraphs', tittle: 'Negociacoes Page' });
});

router.get('/contabilidade', function(req, res, next) {
	res.render('user/contabilidade', { layout: 'noGraphs', tittle: 'Negociacoes Page' });
});

router.get('/contabilidade_teste', function(req, res, next) {
	res.render('user/contabilidade_teste', { layout: 'noGraphs', tittle: 'Negociacoes Page' });
});
...
router.get('/chat', function(req, res, next) {
	res.render('user/chat', { layout: 'chatLayout', tittle: 'Recomendacoes Page' });
});
...
router.get('/activate/:id_gerado', function(req, res) {
	...
	request.get({
		...
		url: 'https://portapi-afonsoocosta53.c9users.io/user/activate',
	}, function(error, response, body) {
		var body2 = JSON.parse(body);
		var msg = body2.msg;
...
router.post('/register', function(req, res) {
	...
	request.post({
		...
		url: 'https://portapi-afonsoocosta53.c9users.io/user/signup',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
	});
...
router.post('/login', function(req, res) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded' },
		url: 'https://portapi-afonsoocosta53.c9users.io/user/authenticate',
		body: bodyText
	}, function(error, response, body) {
		var body2 = JSON.parse(body);
...
router.post('/business_company', function(req, res) {
	...
	request.post({
		...
		url: 'https://portapi-afonsoocosta53.c9users.io/user/business',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
	});
...
router.get('/add_contact/:id', function(req, res, next) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portapi-afonsoocosta53.c9users.io/user/add_contact',
		body: bodyText
	}, function(error, response, body) {
		var body2 = JSON.parse(body);
		var text = body2.msg;
...
router.get('/removerContact/:id', function(req, res, next) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portapi-afonsoocosta53.c9users.io/user/removerContact',
		body: bodyText
	}, function(error, response, body) {
		var body2 = JSON.parse(body);
		var text = body2.msg;
...
router.get('/contacts/:page', function(req, res) {
	...
	if (id_gerado != undefined) {
		request.get({
			headers: { 'authorization': id_gerado },
			url: 'https://portapi-afonsoocosta53.c9users.io/user/userContacts/' + page,
		}, function(error, response, body) {
			var body2 = JSON.parse(body);
...
router.post('/changeinfo', upload.single('imagem'), function(req, res) {
	...
	request.post({
		headers: { 'content-type': 'application/x-www-form-urlencoded', 'authorization': id_gerado },
		url: 'https://portapi-afonsoocosta53.c9users.io/user/changeinfo',
		body: bodyText
	}, function(error, response, body) {
		console.log(body);
	});
